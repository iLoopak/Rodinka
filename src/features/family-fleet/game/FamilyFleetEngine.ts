...
export interface FleetEngineOptions { accent: string; reducedMotion?: boolean; onSnapshot?: (s: FleetSnapshot) => void; onGameOver: (r: ReturnType<typeof resultFromState>) => void; rng?: Rng }
