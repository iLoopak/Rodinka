...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL ?? (import.meta.env.MODE === 'test' ? 'http://127.0.0.1:54321' : undefined)
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY ?? (import.meta.env.MODE === 'test' ? 'test-anon-key' : undefined)
